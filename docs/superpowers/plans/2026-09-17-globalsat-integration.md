...
Fetch targets once, process current snapshots, then up to two pages. Convert gpsTime with target gmtOffset. Call processPosition with source GLOBALSAT, externalId and accuracyM 50.
